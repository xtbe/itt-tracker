          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                name="accountId"
                required
                defaultValue={editingHolding?.account_id || ''}
            ...
            <div>
              ...
              <input
                name="symbol"
                required
                defaultValue={editingHolding?.symbol || ''}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="AAPL"
              />
            </div>
            <div>
              ...
              <input
                name="name"
                required
                defaultValue={editingHolding?.name || ''}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div>
              ...
              <select
                name="type"
                required
                defaultValue={editingHolding?.type || ''}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
            ...
            <div>
              ...
              <select
                name="currency"
                required
                defaultValue={editingHolding?.currency || ''}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
            ...
            <div>
              ...
              <input
                ...
                type="number"
                step="0.01"
                defaultValue={editingHolding?.dividend_yield || ''}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="0.00"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                type="date"
                required
                defaultValue={editingHolding?.purchase_date || ''}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          </div>
